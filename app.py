...
if rate_mode == "NET RATE Mode (0% GST)":
    with st.form("net_billing_form", clear_on_submit=False):
        ...
        with r1_c3:
            s_mrp = st.number_input("MRP (₹)", min_value=0.0, value=selected_batch_info["mrp"] if selected_batch_info else 0.0)
    ...
    with st.form("gross_billing_form", clear_on_submit=False):r1_c1, r1_c2, r1_c3, r1_c4 = st.columns(4)
     ...
     with r1_c4: s_gst_rate = st.number_input("GST (%)", min_value=0.0, value=5.0, step=1.0)r2_c1, r2_c2, r2_c3 = st.columns(3)
